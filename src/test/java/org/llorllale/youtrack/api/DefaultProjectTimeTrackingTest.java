 ...
 * @since 1.0.0
 */
public class DefaultProjectTimeTrackingTest {
  ...
  /**
   * {@link DefaultProjectTimeTracking#enabled()} must be true if timetracking is enabled, 
   * and both an estimation field and a spent time field have been configured.
   * 
   * @throws Exception 
   * @since 1.0.0
   */
  ...
  /**
   * {@link DefaultProjectTimeTracking#enabled()} must be false if settings is disabled, even
   * if an estimation field and a spent time field have been configured.
   * 
   * @throws Exception 
   * @since 1.0.0
   */
  ...
  /**
   * {@link DefaultProjectTimeTracking#enabled()} must be false if an estimation field has not 
   * been configured, even if settings are enabled and a spent time field has been configured.
   * 
   * @throws Exception 
   * @since 1.0.0
   */
  ...
  /**
   * {@link DefaultProjectTimeTracking#enabled()} must be false if a spent time field has not
   * been configured, even if settings are enabled and an estimation field has been configured.
   * 
   * @throws Exception 
   * @since 1.0.0
   */
  ...
  /**
   * {@link DefaultProjectTimeTracking#types()} must return all the workItemTypes returned by 
   * the server.
   * 
   * @throws Exception 
   * @since 1.0.0
